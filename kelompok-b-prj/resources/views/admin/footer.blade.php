<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-blue-50 " >
  <!-- Grid -->
  <div class="text-center">
    <div>
      <a class="flex-none text-xl font-semibold text-black dark:text-white" href="#" aria-label="Brand">KELOMPOK (IF B 21)</a>
    </div>
    <!-- End Col -->

    <div class="mt-3">
      <p class="text-gray-500">© 2023 IFB21. All rights reserved.</p>
    </div>
