...
<div id="docs-sidebar" class="hs-overlay h-full hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed left-0 bottom-1 z-[0] w-64 bg-white border-r border-gray-200 pt-20 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700">
